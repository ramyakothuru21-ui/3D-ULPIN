    ...
    <header className="h-16 bg-white border-b border-slate-200 px-4 sm:px-6 flex items-center justify-between gap-4 z-30 sticky top-0 shadow-sm select-none">
      ...
      <div className="flex items-center gap-2 sm:gap-3">
        ...
        <div className="flex items-center gap-2 pl-2 border-l border-slate-200">
          <label className="flex items-center gap-1.5 cursor-pointer text-xs select-none" title="Toggle Simulated AP Citizen Registry for Hackathon Presentation">
            <input
              type="checkbox"
            ...
            <span className={`text-[11px] font-semibold hidden xl:inline ${enableDemoOverlay ? 'text-brand-700' : 'text-slate-400'}`}>
              Demo Records {enableDemoOverlay && <span className="text-[9px] px-1 py-0.2 bg-amber-100 text-amber-800 font-mono rounded font-bold">DEMO</span>}
            </span>
          </label>
        </div>
      </div>
